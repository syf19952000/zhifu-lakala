...
// 重要 yisheng中 $mch_id = $response['orgMercode'];
// zhifu-wechat中 $mch_id = $json_xml['mch_id'];
...
if ((!isset($result['out_trade_no'])) && $resultNo == '2'){
    ...
    $result = '';
    $sql = "INSERT INTO `order` (out_trade_no, transaction_id, money, qcjParamStr, nonce_str, mch_id, `result`, open_id, zt, `source`) VALUES ('$out_trade_no', '$transaction_id', $money, '$qcj', '$nonce_str', '$mch_id', '', '$open_id', 1, 'boqun')";
